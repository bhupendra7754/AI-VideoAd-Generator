...
export default function Hero() {
    ...
    const galleryStripImages = [
        'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?w=80&w=1600&auto=format&fit=crop',
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                An AI-powered video ad generator built for modern marketing.
Create, customize, and publish stunning video ads effortlessly—save time and boost results
