...
const UploadZone = ({ label, file, onClear, onChange }: UploadZoneProps) => {
  return (
    <div className="relative group">
      <div
        className={`relative h-64 rounded-2xl border-2 border-dashed transition-all duration-300 flex flex-col
        items-center justify-center bg-white/2 p-6
        ${
          file
          ...
          <>
            ...
            >
              <button
                ...
                hover:bg-red-500/20 text-white hover:text-red-400 transition-colors"
              >
            ...
            <div
              ...
              backdrop-blur-md p-3 rounded-l-xl border border-white/10"
            >
