                ...
                >
                  ...
                  {gen.generatedImage && (
                    <a
                      ...
                      download
                      className="flex gap-2 px-4 py-2 hover:bg-black/10 cursor-pointer"
                    >
                  ...
                  {(gen.generatedImage || gen.generatedVideo) && (
                    <button
                      className="flex  w-full gap-2 px-4 py-2 items-center hover:bg-black/10 cursor-pointer"
                      onClick={() =>
                        navigator.share({
                  ...
                  {/* delete button */}
                  <button
                    className="flex w-full items-center gap-2 px-4 py-2 hover:bg-red-950/10 text-red-400 cursor-pointer"
        ...
        <div className="p-4">
          ...
          {!ForCommunity && (
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              onClick={()=>{navigate(`/result/${gen.id}`); window.scrollTo(0,0)}}>View Details</GhostButton>
